...
$(function() {
    $(".br").click(function(){
        ...
        $(".apresentacao__conteudo__sobre ul:nth-child(1) li:nth-child(4) p").text(
            "Profissionalmente, adquiri insights inestimáveis trabalhando como Estagiário de Suporte na Leadfy Imob e, posteriormente, como Estagiário de Inteligência de Mercado na HedgePoint Global Markets. Atualmente, atuo como desenvolvedor voluntário na All Juice Capital, uma startup inglesa, onde contribuo com o desenvolvimento de produtos de software. Esses papéis aperfeiçoaram minhas habilidades de trabalho em equipe, resolução de problemas e adaptação a ambientes dinâmicos, proporcionando-me uma base sólida para navegar na interseção de tecnologia e finanças."
        );
